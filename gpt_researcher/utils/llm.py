...
async def create_chat_completion(
    ...
    if llm_provider == "openai":
        ...
        provider_kwargs['azure_endpoint'] = os.environ.get("AZURE_OPENAI_ENDPOINT")
        provider_kwargs['api_key'] = os.environ.get("AZURE_OPENAI_API_KEY")
        provider_kwargs['api_version'] = os.environ.get("AZURE_OPENAI_API_VERSION")
